...
getwd()
setwd("C:/Users/I love you/Documents/R")
getwd()
...
nrown(data2013) #187 rows. Equal split.

#Create the additional dataframes
add1960 <- _(Code=_Country_Code, Life.Exp=Life_Expectancy_At_Birth_1960)
add2013 <- _(_=_, _=_)
